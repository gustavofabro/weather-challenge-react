...
function getGridPointsCache(latLong: {lat: string, lng: string}): GridPoints | null {
...
function saveGridPointsCache(latLong: {lat: string, lng: string}, gridPoints: GridPoints): void {
...
export { getGridPointsCache, saveGridPointsCache };
